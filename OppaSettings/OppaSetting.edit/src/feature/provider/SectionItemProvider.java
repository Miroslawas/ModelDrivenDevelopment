...
/**
 * This is the item provider adapter for a {@link feature.Section} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SectionItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 FeaturePackage.Literals.SECTION__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(FeaturePackage.Literals.SECTION__FEATURES);
			childrenFeatures.add(FeaturePackage.Literals.SECTION__SUBSECTIONS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Section.class)) {
			case FeaturePackage.SECTION__NAME:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case FeaturePackage.SECTION__FEATURES:
			case FeaturePackage.SECTION__SUBSECTIONS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(FeaturePackage.Literals.SECTION__FEATURES,
				 FeatureFactory.eINSTANCE.createFeature()));

		newChildDescriptors.add
			(createChildParameter
				(FeaturePackage.Literals.SECTION__SUBSECTIONS,
