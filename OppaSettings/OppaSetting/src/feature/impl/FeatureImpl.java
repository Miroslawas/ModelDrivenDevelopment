 ...
 *   <li>{@link feature.impl.FeatureImpl#getId <em>Id</em>}</li>
 *   <li>{@link feature.impl.FeatureImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link feature.impl.FeatureImpl#getType <em>Type</em>}</li>
 *   <li>{@link feature.impl.FeatureImpl#getExcludes <em>Excludes</em>}</li>
 *   <li>{@link feature.impl.FeatureImpl#getDepends <em>Depends</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FeatureImpl extends EObjectImpl implements Feature {
	 ...
	 * @ordered
	 */
	protected static final Type TYPE_EDEFAULT = Type.SWITCH;
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FeaturePackage.FEATURE__ID, oldId, id));
	}
	...
	public EList<Feature> getExcludes() {
		if (excludes == null) {
			excludes = new EObjectResolvingEList<Feature>(Feature.class, this, FeaturePackage.FEATURE__EXCLUDES);
		}
		return excludes;
	}
	...
	public EList<Feature> getDepends() {
		if (depends == null) {
			depends = new EObjectResolvingEList<Feature>(Feature.class, this, FeaturePackage.FEATURE__DEPENDS);
		}
		return depends;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FeaturePackage.FEATURE__NAME:
				return getName();
			case FeaturePackage.FEATURE__ID:
				return getId();
			case FeaturePackage.FEATURE__DESCRIPTION:
				return getDescription();
			case FeaturePackage.FEATURE__TYPE:
				return getType();
			case FeaturePackage.FEATURE__EXCLUDES:
				return getExcludes();
			case FeaturePackage.FEATURE__DEPENDS:
				return getDepends();
		}
