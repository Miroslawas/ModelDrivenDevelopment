...
public class FeatureFactoryImpl extends EFactoryImpl implements FeatureFactory {
	...
	public static FeatureFactory init() {
		try {
			FeatureFactory theFeatureFactory = (FeatureFactory)EPackage.Registry.INSTANCE.getEFactory("platform:/resource/OppaSetting/Model/feature.ecore"); 
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case FeaturePackage.SETTINGS_MODEL: return createSettingsModel();
			case FeaturePackage.SECTION: return createSection();
	...
	public SettingsModel createSettingsModel() {
		SettingsModelImpl settingsModel = new SettingsModelImpl();
