...
public class FeaturePackageImpl extends EPackageImpl implements FeaturePackage {
	 ...
	 * @generated
	 */
	private EClass settingsModelEClass = null;
	 ...
	 * @generated
	 */
	public EClass getSettingsModel() {
		return settingsModelEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getSettingsModel_Sections() {
		return (EReference)settingsModelEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getSection_Features() {
	...
	public void createPackageContents() {
		...
		settingsModelEClass = createEClass(SETTINGS_MODEL);
		createEReference(settingsModelEClass, SETTINGS_MODEL__SECTIONS);

		sectionEClass = createEClass(SECTION);
		createEAttribute(sectionEClass, SECTION__NAME);
		createEReference(sectionEClass, SECTION__FEATURES);
		...
		createEReference(featureEClass, FEATURE__EXCLUDES);
	...
	public void initializePackageContents() {
		...
		initEClass(settingsModelEClass, SettingsModel.class, "SettingsModel", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getSettingsModel_Sections(), this.getSection(), null, "sections", null, 0, -1, SettingsModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getSection_Features(), this.getFeature(), null, "features", null, 1, -1, Section.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getFeature_Type(), this.getType(), "type", null, 0, 1, Feature.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getFeature_Excludes(), this.getFeature(), null, "excludes", null, 0, -1, Feature.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		addEEnumLiteral(typeEEnum, Type.SWITCH);
		addEEnumLiteral(typeEEnum, Type.RANGE);
